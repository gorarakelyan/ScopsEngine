...
*/
  ...
  if( !isset( $_GET['ajax'] ) || !$_GET['ajax'] == 1 ) {
    ...
    if( $_GET['tab'] == 'userlink' ) {
      ...
      header( 'location:'._root_.'/id' . $url . '/' . ( $_GET['section'] != '' ? $_GET['section'] : 'wall' ) );
    }
    ...
    else if( $_GET['tab'] == 'post' || $_GET['tab'] == 'game' || $_GET['tab'] == 'chat' ) echo 'ajaxQuery( \''.$_GET['tab'].'\' , \'\' , \''.$_GET['id'].'\' , true )';
    ...
    $dataArr['langs'] = $langs;
    $dataArr['tpl'] = tpl(dirname(__FILE__).'/../themes/'._theme_.'/tpl/tab.tpl');
